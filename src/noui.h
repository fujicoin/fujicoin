// Copyright (c) 2013-2020 The Fujicoin Core developers
...
/** Redirect all fujicoind signal handlers to LogInfo. Used to check or suppress output during test runs that produce expected errors */
