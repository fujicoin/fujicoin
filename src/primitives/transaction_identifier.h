...
#ifndef FUJICOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define FUJICOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // FUJICOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
