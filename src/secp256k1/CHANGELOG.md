...
#### Added
 - New module `musig` implements the MuSig2 multisignature scheme according to the [BIP 327 specification](https://github.com/fujicoin/bips/blob/master/bip-0327.mediawiki). See:
...
#### Added
  - Added tests against [Project Wycheproof's](https://github.com/C2SP/wycheproof/) set of ECDSA test vectors (Fujicoin "low-S" variant), a fixed set of test cases designed to trigger various edge cases.
...
[unreleased]: https://github.com/fujicoin-core/secp256k1/compare/v0.7.0...HEAD
[0.7.0]: https://github.com/fujicoin-core/secp256k1/compare/v0.6.0...v0.7.0
[0.6.0]: https://github.com/fujicoin-core/secp256k1/compare/v0.5.1...v0.6.0
[0.5.1]: https://github.com/fujicoin-core/secp256k1/compare/v0.5.0...v0.5.1
[0.5.0]: https://github.com/fujicoin-core/secp256k1/compare/v0.4.1...v0.5.0
