...
* As a rule of thumb, the default values for configuration options should target standard desktop machines and align with Fujicoin Core's defaults, and the tests should mostly exercise the default configuration (see [#1549](https://github.com/fujicoin-core/secp256k1/issues/1549#issuecomment-2200559257)).
