...
#ifndef FUJICOIN_TXREQUEST_H
#define FUJICOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://fujicoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
