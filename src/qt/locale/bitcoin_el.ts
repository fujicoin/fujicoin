...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Επιλέξτε τη διεύθυνση στην οποία θα στείλετε fujicoin</translation>
    </message>
    <message>
        <source>Choose the address to receive coins with</source>
        <translation type="unfinished">Επιλέξτε τη διεύθυνση παραλαβής fujicoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Στείλτε κέρματα σε μια διεύθυνση Fujicoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Υπογράψτε μηνύματα με τις διευθύνσεις Fujicoin σας για να αποδείξετε ότι σας ανήκουν</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Επαληθεύστε μηνύματα για να βεβαιωθείτε ότι υπογράφηκαν με τις καθορισμένες διευθύνσεις Fujicoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Αίτηση πληρωμών (δημιουργεί QR codes και fujicoin: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Φόρτωση μερικώς υπογεγραμμένης συναλλαγής Fujicoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Φόρτωση μερικώς υπογεγραμμένης συναλλαγής Fujicoin από το πρόχειρο</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Εμφανίστε το μήνυμα βοήθειας του %1 για να δείτε μια λίστα με τις διαθέσιμες επιλογές της γραμμής εντολών του Fujicoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας block του Fujicoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Πλήρης διαδρομή ενός script συμβατού με το %1 (π.χ.: C:\Downloads\hwi.exe ή /Users/you/Downloads/hwi.py). Προσοχή: ένα κακόβουλο λογισμικό μπορεί να κλέψει τα fujicoin σας!</translation>
    </message>
    <message>
        ...
        <translation type="unfinished">Ανοίξτε αυτόματα τη πόρτα του Fujicoin client στο router. Αυτό λειτουργεί μόνο όταν το router σας υποστηρίζει PCP ή NAT-PMP και είναι ενεργοποιημένο. Η εξωτερική πόρτα μπορεί να είναι τυχαία.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Σύνδεση στο δίκτυο Fujicoin μέσω SOCKS5 proxy.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Διαλέξτε την προεπιλεγμένη υποδιαίρεση που θα εμφανίζεται όταν στέλνετε fujicoins.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Συνδεθείτε στο δίκτυο Fujicoin μέσω ξεχωριστού SOCKS5 proxy για τις υπηρεσίες onion του Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Διευθύνσεις δικτύου που χρησιμοποιεί αυτήν τη στιγμή ο Fujicoin κόμβος σας για να επικοινωνεί με άλλους κόμβους.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Αποστολή fujicoin</translation>
    </message>
    <message>
...
Σημείωση: Εφόσον η χρέωση υπολογίζεται ανά byte, ένας ρυθμός χρέωσης των «100 satoshis ανά kvB» για μέγεθος συναλλαγής 500 ψηφιακών bytes (το μισό του 1 kvB) θα απέφερε χρέωση μόλις 50 satoshis.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα blocks, οι εξορύκτες καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνεται όταν θα υπάρχει μεγαλύτερη ζήτηση για συναλλαγές fujicoin από ότι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Δημιουργεί μια συναλλαγή Fujicoin με μερική υπογραφή (PSBT) για χρήση με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα hardware πορτοφόλι συμβατό με PSBT.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished"> Επιβεβαιώστε την αποστολή fujicoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Επαληθεύστε το μήνυμα για να αποδειχθεί πως υπογράφηκε από τη συγκεκριμένη διεύθυνση Fujicoin</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation type="unfinished">Επιβεβαίωση &amp;Μηνύματος</translation>
