      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->fujicoinAtStartup->setToolTip(ui->fujicoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->fujicoinAtStartup->setText(ui->fujicoinAtStartup->text().arg(CLIENT_NAME));

    ui->openFujicoinConfButton->setToolTip(ui->openFujicoinConfButton->toolTip().arg(CLIENT_NAME));
