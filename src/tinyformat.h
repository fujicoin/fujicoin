...
#include <algorithm>
#include <attributes.h> // Added for Fujicoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Fujicoin Core
#include <util/string.h> // Added for Fujicoin Core
...
// Added for Fujicoin Core. Similar to std::runtime_format from C++26.
...
// Added for Fujicoin Core. Wrapper for checking format strings at compile time.
