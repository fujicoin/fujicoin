...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 3776);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 13776);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 43776);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 33776);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 16776);
    }
    assert(false);
}
