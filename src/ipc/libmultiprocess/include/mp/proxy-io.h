...
extern thread_local ThreadContext g_thread_context; // NOLINT(fujicoin-nontrivial-threadlocal)
// Silence nonstandard fujicoin tidy error "Variable with non-trivial destructor
