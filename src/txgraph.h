...
#ifndef FUJICOIN_TXGRAPH_H
#define FUJICOIN_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingfujicoin.org/t/introduction-to-cluster-linearization/1032
 *
