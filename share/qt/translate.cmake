...
function(extract_strings output)
  ...
  file(STRINGS "fujicoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *fujicoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"fujicoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/fujicoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/fujicoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/fujicoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/fujicoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/fujicoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/fujicoin_en.xlf" fujicoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" fujicoin_en "${fujicoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" fujicoin_en "${fujicoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/fujicoin_en.xlf" "${fujicoin_en}")
