...
# CONFIGFLAGS
CONFIGFLAGS="-DREDUCE_EXPORTS=ON -DBUILD_BENCH=OFF -DBUILD_TESTS=OFF -DBUILD_GUI_TESTS=OFF -DBUILD_FUZZ_BINARY=OFF"
...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/fujicoin-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    case "$HOST" in
        ...
        *darwin*)
            ...
            mv build/dist/Fujicoin-Core.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
