...
```
$ python3 contrib/tracing/p2p_monitor.py $(pidof fujicoind)
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py $(pidof fujicoind)
```
...
```
$ ./build/bin/fujicoind -signet -reindex
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py $(pidof fujicoind)
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py $(pidof fujicoind)
```
