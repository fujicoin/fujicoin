...
Fujicoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Fujicoin Core

**When configuring Fujicoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Fujicoin Core:
...
variables will be set when generating the Fujicoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
