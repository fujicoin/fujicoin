...
* for `src/ipc/libmultiprocess`: https://github.com/fujicoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/fujicoin-core/leveldb-subtree.git (branch fujicoin-fork)
* for `src/minisketch`: https://github.com/fujicoin-core/minisketch.git (branch master)
