...
fn get_linter_list() -> Vec<&'static Linter> {
    vec![
        ...
        &Linter {
            description: "Check that no symbol from fujicoin-config.h is used without the header being included",
        ...
        git()
            .args([
                ...
                if mode {
                    ...
                    "#include <config/fujicoin-config.h>" // Catch redundant includes with and without the IWYU pragma
                },
                "--",
            ])
