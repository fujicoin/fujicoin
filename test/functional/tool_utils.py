...
# Copyright 2016-present The Fujicoin Core developers
...
class ToolUtils(FujicoinTestFramework):
    ...
    def run_test(self):
        ...
        with open(self.testcase_dir / "fujicoin-util-test.json", encoding="utf8") as f:
