...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"fujicoin-cli -h\" for help or \"fujicoin-cli listwallets\" to see "
...
class TestFujicoinCli(FujicoinTestFramework):
    ...
    def run_test(self):
        ...
        # Prevent fujicoin-cli from using existing rpcport in conf
