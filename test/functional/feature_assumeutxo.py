...
class AssumeutxoTest(FujicoinTestFramework):
    ...
    def test_invalid_file_path(self):
        self.log.info("Test fujicoind should fail when file path is invalid.")
        node = self.nodes[0]
    ...
    def test_snapshot_with_less_work(self, dump_output_path):
        self.log.info("Test fujicoind should fail when snapshot has less accumulated work than this node.")
        node = self.nodes[0]
