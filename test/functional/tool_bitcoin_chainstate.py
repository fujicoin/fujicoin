...
class FujicoinChainstateTest(FujicoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_fujicoin_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing fujicoin-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    FujicoinChainstateTest(__file__).main()
