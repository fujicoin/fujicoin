...
function(add_maintenance_targets)
  ...
  foreach(target IN ITEMS fujicoin fujicoind fujicoin-node fujicoin-qt fujicoin-gui fujicoin-cli fujicoin-tx fujicoin-util fujicoin-wallet test_fujicoin bench_fujicoin)
    if(TARGET ${target})
...
function(add_windows_deploy_target)
  if(MINGW AND TARGET fujicoin AND TARGET fujicoin-qt AND TARGET fujicoind AND TARGET fujicoin-cli AND TARGET fujicoin-tx AND TARGET fujicoin-wallet AND TARGET fujicoin-util)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:fujicoin> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:fujicoin>
