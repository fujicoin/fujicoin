...
```sh
$ git clone --depth=1 https://github.com/fujicoin-core/qa-assets
...
an instrumentalized libc++, then using it to build [Fujicoin Core dependencies
from source](../depends/README.md) and finally the Fujicoin Core fuzz binary
