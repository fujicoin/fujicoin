...
```sh
cmake --build build --target fujicoind fujicoin-cli
cmake --build build --target fujicoin-qt
cmake --build build --target bench_fujicoin
```
...
> e.g. github.com/fujicoin/fujicoin.git or for the GUI github.com/fujicoin-core/gui
