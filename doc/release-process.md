...
* Update fujicoin.conf and commit changes if they exist, see [gen-fujicoin-conf.sh](https://github.com/bitcoin/bitcoin/blob/master/contrib/devtools/README.md#gen-bitcoin-confsh).
