...
libfujicoinconsensus Removal
---------------------------

The libfujicoin-consensus library was deprecated in 27.0 and is now completely removed. (#29648)
...
- The `warnings` field in `getblockchaininfo`, `getmininginfo` and
  ...
  can be temporarily restored by running Fujicoin Core with the configuration
...
are now required to compile Fujicoin Core. (#29091, #30263)
...
- A new `-testdatadir` option has been added to `test_fujicoin` to allow specifying the
